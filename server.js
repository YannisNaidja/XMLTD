...
MongoClient.connect(url, {useNewUrlParser: true}, (err, client) => {
	...
	app.get("/products/recherche/:category_code/:product_name/:pricemin/:pricemax/:brand/:type/:extra", (req,res) => {
		console.log("/basket/recherche" + req.params.category_code+ req.params.product_name
		+ req.params.pricemin + req.params.pricemax + req.params.brand + req.params.type + req.params.extra);
...
/*	app.post("/connexion" , (req,res) => {
		...
		db.collection("members").find(req.body)
			.toArray((err, documents) => {
